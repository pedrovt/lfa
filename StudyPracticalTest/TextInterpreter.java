...
public class TextInterpreter extends TextGrammarBaseVisitor<String> {
	...
	@Override public String visitTextInput(TextGrammarParser.TextInputContext ctx) { 
        return visit(ctx.input()); 
    }
	
	@Override public String visitTextConcat(TextGrammarParser.TextConcatContext ctx){ 
    ...
    @Override public String visitTextReplace(TextGrammarParser.TextReplaceContext ctx) { 
        String textA = visit(ctx.text(0));
        String textB = visit(ctx.text(1));
	...
	@Override public String visitTextParenthesis(TextGrammarParser.TextParenthesisContext ctx) { 
        return visit(ctx.text()); 
    }
	
    @Override public String visitTextID(TextGrammarParser.TextIDContext ctx) {
	...
	@Override public String visitTextSTRING(TextGrammarParser.TextSTRINGContext ctx) {  
